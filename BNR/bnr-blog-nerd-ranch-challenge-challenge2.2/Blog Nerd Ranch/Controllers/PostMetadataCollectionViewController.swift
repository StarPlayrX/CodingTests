...
class PostMetadataCollectionViewController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    func group(by grouping: Grouping) {
        ...
        case Grouping.author : dataSource.groupByAuthor(sorting: dataSource.ordering.sorting)
        case Grouping.month  : dataSource.groupByMonthAndYear(sorting: dataSource.ordering.sorting)
    ...
    func sort(_ sorting: Sorting) {
        ...
        case .alphabeticalByAuthor(ascending: let ascending) : dataSource.sortListByAuthor(ascending: ascending, sorting: dataSource.ordering.sorting, grouping: dataSource.ordering.grouping )
        case .alphabeticalByTitle(ascending: let ascending)  : dataSource.sortListByTitle(ascending: ascending, sorting: dataSource.ordering.sorting, grouping: dataSource.ordering.grouping )
        case .byPublishDate(recentFirst: let recentFirst)    : dataSource.sortListByPosts(ascending: recentFirst, sorting: dataSource.ordering.sorting, grouping: dataSource.ordering.grouping )
        }
